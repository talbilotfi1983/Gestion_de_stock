...
<title><spring:message code="common.client" /></title>
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="common.client" />
						</h1>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<ol class="breadcrumb">
								<li><a href="${ajouterClientUrl}"><i
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<table width="100%"
										...
										<thead>
											<tr>
												<th><spring:message code="client.photo" /></th>
											...
											<c:forEach items="${list}" var="client">
												<tr class="something">
													<td class="img-fluid col-md-2"><img
														src="${client.getPhoto()}" width=100% height=120px /></td>
													<td class="col-md-2">${client.getNom()}</td>
													<td class="col-md-2">${client.getPrenom()}</td>
													<td class="col-md-2">${client.getAdresse()}</td>
													<td class="col-md-2">${client.getEmail()}</td>
													<td class="col-md-2"><a
														href="${modifierClientUrl}${client.getId()}"><i
															class="fa fa-edit"></i></a> &nbsp;|&nbsp; <a
														href="javascript:void(0)" data-toggle="modal"
														data-target="#modelClient${client.getId()}">
															<i class="fa fa-trash-o"></i>
													</a>
														<div class="modal fade"
															id="modelClient${client.getId()}" tabindex="-1"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-footer">
																		<a href="${clientUrl}" class="btn btn-default">
																			<i class="fa fa-arrow-left">&nbsp;<spring:message
																					code="common.annuler" /></i>
																		</a> <a
																			href="${suprimerClientUrl}/${client.getId()}"
