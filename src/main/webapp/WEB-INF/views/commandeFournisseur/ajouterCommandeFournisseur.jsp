...
<title><spring:message code="commandeFournisseur.titre.ajouter" /></title>
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="commandeFournisseur.titre.ajouter" />
						</h1>
					</div>

					<div class="panel-body col-lg-6">

						<f:form modelAttribute="commandeFournisseur" method="post"
							action="${majCommandeFournisseurUrl}" >

							<f:hidden path="id" />
							
							<div class="form-group">
								<label class="control-label"><spring:message
										code="commandeFournisseur.date" /></label>
								<f:input path="date" class="form-control" type="date"
									placeholder="Date Commande fournisseur" />
							</div>
							<div class="form-group">
								<label class="control-label"><spring:message
										code="commandeFournisseur.fournisseur" /></label>
								<f:select class="form-control" path="fournisseur.id"
									items="${fournisseurs}" itemLabel="nom" itemValue="id">
							...
							<div class="panel-footer">
								...
								<a href="${commandeFournisseurUrl}" class="btn btn-danger"> <i
