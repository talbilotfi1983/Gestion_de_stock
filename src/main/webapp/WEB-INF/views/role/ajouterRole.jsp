...
<title><spring:message code="role.titre.ajouter" /></title>
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="role.titre.ajouter" />
						</h1>
					</div>

					<div class="panel-body col-lg-6">

						<f:form modelAttribute="role" method="post"
							action="${majRoleUrl}">
							...
							<div class="form-group">
								...
								<f:input  class="form-control" path="roleName"
									placeholder="Role name " />
							</div>

							<div class="form-group">
								<label class="control-label"><spring:message
										code="role.utilisateur" /></label>
								<f:select class="form-control" path="utilisateur.id"
									items="${utilisateurs}" itemLabel="nom" itemValue="id">
							...
							<div class="panel-footer">
								...
								<a href="${roleUrl}" class="btn btn-danger"> <i
