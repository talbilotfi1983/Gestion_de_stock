...
<title><spring:message code="common.fournisseur" /></title>
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="common.fournisseur" />
						</h1>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<ol class="breadcrumb">
								<li><a href="${ajouterFournisseurUrl}"><i class="fa fa-plus">&nbsp;<spring:message
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<table width="100%"
										...
										<thead>
											<tr>
												<th><spring:message code="fournisseur.photo" /></th>
												<th><spring:message code="fournisseur.nom" /></th>
												<th><spring:message code="fournisseur.prenom" /></th>
												<th><spring:message code="fournisseur.adresse" /></th>
												<th><spring:message code="fournisseur.email" /></th>
												<th><spring:message code="common.actions" /></th>
											</tr>
										</thead>
										<tbody>
											<c:forEach items="${list}" var="fournisseur">
												<tr class="something">
													<td class="img-fluid col-md-2"><img
														src="${fournisseur.getPhoto()}" width=100% height=120px /></td>
													<td class="col-md-2">${fournisseur.getNom()}</td>
													<td class="col-md-2">${fournisseur.getPrenom()}</td>
													<td class="col-md-2">${fournisseur.getAdresse()}</td>
													<td class="col-md-2">${fournisseur.getEmail()}</td>
													<td class="col-md-2"><a
														href="${modifierFournisseurUrl}${fournisseur.getId()}"><i
															class="fa fa-edit"></i></a> &nbsp;|&nbsp; <a
														href="javascript:void(0)" data-toggle="modal"
														data-target="#modelFournisseur${fournisseur.getId()}"> <i
															class="fa fa-trash-o"></i>
													</a>
														<div class="modal fade" id="modelFournisseur${fournisseur.getId()}"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-footer">
																		<a href="${fournisseurUrl}" class="btn btn-default"> <i
																			class="fa fa-arrow-left">&nbsp;<spring:message
																					code="common.annuler" /></i>
																		</a> <a href="${suprimerFournisseurUrl}/${fournisseur.getId()}"
