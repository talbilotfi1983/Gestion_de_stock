...
<title><spring:message code="fournisseur.titre.ajouter" /></title>
...
<body>
	...
	<div id="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="fournisseur.titre.ajouter" />
						</h1>
					</div>

					<div class="panel-body col-lg-6">

						<f:form modelAttribute="fournisseur" method="post"
							action="${majFournisseurUrl}" enctype="multipart/form-data">
							...
							<div class="panel-footer">
								...
								<a href="${fournisseurUrl}" class="btn btn-danger"> <i
		...
		<script src="<%=contextPath%>/resources/javascript/fournisseur.js"></script>
</body>
