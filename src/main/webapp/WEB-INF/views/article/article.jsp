...
<title><spring:message code="common.article" /></title>
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="common.article" />
						</h1>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<ol class="breadcrumb">
								<li><a href="${ajouterArticleUrl}"><i class="fa fa-plus">&nbsp;<spring:message
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<table width="100%"
										...
										<thead>
											<tr>
												<th><spring:message code="article.photo" /></th>
												<th><spring:message code="article.code" /></th>
												<th><spring:message code="article.designation" /></th>
												<th><spring:message code="article.prixUnitaireHt" /></th>
												<th><spring:message code="article.prixUnitaireTtc" /></th>
												<th><spring:message code="article.tauxTva" /></th>
												<th><spring:message code="article.category" /></th>
											...
											<c:forEach items="${list}" var="article">
												<tr class="something">
													<td class="img-fluid col-md-2"><img
														src="${article.getPhoto()}" width=100% height=120px /></td>
													<td class="col-md-2">${article.getId()}</td>
													<td class="col-md-2">${article.getDesignation()}</td>
													<td class="col-md-2">${article.getPrixUnitaireHt()}</td>
													<td class="col-md-2">${article.getPrixUnitaireTtc()}</td>
													<td class="col-md-2">${article.getTauxTva()}</td>
													<td class="col-md-2">${article.getCategory().getCode()}</td>
													
													<td class="col-md-2"><a
														href="${modifierArticleUrl}${article.getId()}"><i
															class="fa fa-edit"></i></a> &nbsp;|&nbsp; <a
														href="javascript:void(0)" data-toggle="modal"
														data-target="#modelArticle${article.getId()}"> <i
															class="fa fa-trash-o"></i></a>
														<div class="modal fade"
															id="modelArticle${article.getId()}" tabindex="-1"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-footer">
																		<a href="${articleUrl}" class="btn btn-default"> <i
																			class="fa fa-arrow-left">&nbsp;<spring:message
																					code="common.annuler" /></i>
																		</a> <a
																			href="${suprimerArticleUrl}/${article.getId()}"
