...
<title><spring:message code="common.mouvementStock" /></title>
...
<body>
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="common.mouvementStock" />
						</h1>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<ol class="breadcrumb">
								<li><a href="${ajouterMouvementStockUrl}"><i
									...
									<table width="100%"
										...
										<thead>
											<tr>
												...
												<th><spring:message code="mouvementStock.date" /></th>
												<th><spring:message code="mouvementStock.quantite" /></th>
												<th><spring:message code="mouvementStock.type" /></th>
												<th><spring:message code="common.actions" /></th>
											</tr>
										</thead>
										<tbody>
											<c:forEach items="${list}" var="mouvementStock">
												<tr class="something">
													<td class="col-md-2">${mouvementStock.getDate()}</td>
													<td class="col-md-2">${mouvementStock.getQuantite()}</td>
													<td class="col-md-2">${mouvementStock.getArticle().getDesignation()}</td>
													<td class="col-md-1"><a
														href="${modifierMouvementStockUrl}${mouvementStock.getId()}"><i
															class="fa fa-edit"></i></a> &nbsp;|&nbsp; <a
														href="javascript:void(0)" data-toggle="modal"
														data-target="#modelMouvementStock${mouvementStock.getId()}">
															<i class="fa fa-trash-o"></i>
													</a>
														<div class="modal fade"
															id="modelMouvementStock${mouvementStock.getId()}"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-footer">
																		<a href="${mouvementStockUrl}" class="btn btn-default">
																			<i class="fa fa-arrow-left">&nbsp;<spring:message
																					code="common.annuler" /></i>
																		</a> <a
																			href="${suprimerMouvementStockUrl}/${mouvementStock.getId()}"
	...
	<script src="<%=contextPath%>/resources/javascript/mouvementStock.js"></script>
