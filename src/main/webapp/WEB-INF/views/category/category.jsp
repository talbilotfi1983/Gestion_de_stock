...
<title><spring:message code="common.category" /></title>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="row">
						<div class="col-lg-12">
							<ol class="breadcrumb">
								<li><a href="${ajouterCategoryUrl}"><i
									...
									<table width="100%"
										...
										<thead>
											<tr>
												...
												<th><spring:message code="category.designation" /></th>
											</tr>
										</thead>
										<tbody>
											<c:forEach items="${list}" var="category">
												<tr class="something">
													<td class="col-md-2">${category.getCode()}</td>
													<td class="col-md-2">${category.getDesignation()}</td>
													<td class="col-md-2"><a
														href="${modifierCategoryUrl}${category.getId()}"><i
															class="fa fa-edit"></i></a> &nbsp;|&nbsp; <a
														href="javascript:void(0)" data-toggle="modal"
														data-target="#modelCategory${category.getId()}"> <i
															class="fa fa-trash-o"></i></a>
														<div class="modal fade"
															id="modelCategory${category.getId()}" tabindex="-1"
															...
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<div class="modal-footer">
																		<a href="${categoryUrl}" class="btn btn-default">
																			<i class="fa fa-arrow-left">&nbsp;<spring:message
																					code="common.annuler" /></i>
																		</a> <a href="${suprimerCategoryUrl}/${category.getId()}"
