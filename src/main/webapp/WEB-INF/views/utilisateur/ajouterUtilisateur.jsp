...
<title><spring:message code="utilisateur.titre.ajouter" /></title>
...
<body>
	...
	<div id="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header">
							<spring:message code="utilisateur.titre.ajouter" />
						</h1>
					</div>

					<div class="panel-body col-lg-6">

						<f:form modelAttribute="utilisateur" method="post"
							action="${majUtilisateurUrl}" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="control-label"><spring:message
										code="utilisateur.nom" /></label>
								<f:input path="nom" class="form-control" type="text"
									placeholder="Nom Utilisateur" />
							</div>
							<div class="form-group">
								<label class="control-label"><spring:message
										code="utilisateur.prenom" /></label>
								<f:input class="form-control" path="prenom" placeholder="Prenom" />
							</div>
							<div class="form-group">
								<label class="control-label"><spring:message
										code="utilisateur.motDePasse" /></label>
								<f:input class="form-control" path="motDePasse" placeholder="Mot de passe" />
							</div>
							<div class="form-group">
								<label class="control-label"><spring:message
										code="utilisateur.email" /></label>
							...
							<div class="panel-footer">
								...
								<a href="${utilisateurUrl}" class="btn btn-danger"> <i
		...
		<script src="<%=contextPath%>/resources/javascript/utilisateur.js"></script>
</body>
